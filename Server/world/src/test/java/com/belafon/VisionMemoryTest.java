...
public class VisionMemoryTest {
    ...
    public void testVisibleObjectSpotted() {
        ...
        final TestingCreature creature_1 = new TestingCreature(world, "creature_1", world.maps.maps[0].places[0][0], 42,
                "appearenceTest", 100);
        final TestingCreature creature_2 = new TestingCreature(world, "creature_2", world.maps.maps[0].places[0][0], 43,
                "appearenceTest", 100);
        world.creatures.add(creature_1);
        world.creatures.add(creature_2);

        creature_1.addVisibleObjects(creature_2);
        creature_1.addVisibleObjects(creature_2);
