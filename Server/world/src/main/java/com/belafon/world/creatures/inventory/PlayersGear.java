...
import com.belafon.world.items.typeItem.ClothesTypeItem;
...
public class PlayersGear extends Gear{
    ...
    public boolean putOn(Clothes clothes) {
        ...
        switch(clothes.getType().typeOfClothes) {
			case head:
                if(head != null)warm -= head.getType().warm;
				head = clothes;
				break;
			case shoulders:
                if(shoulders != null)warm -= shoulders.getType().warm;
                shoulders = clothes;
				break;
			case arms:
                if(arms != null)warm -= arms.getType().warm;
                arms = clothes;
				break;
			case body:
                if(body != null)warm -= body.getType().warm;
                body = clothes;
				break;
			case feets:
                if(feets != null)warm -= feets.getType().warm;
                feets = clothes;
				break;
			case hands:
                if(hands != null)warm -= hands.getType().warm;
                hands = clothes;
				break;
			case legs:
                if(legs != null)warm -= legs.getType().warm;
                legs = clothes;
				break;
		}
