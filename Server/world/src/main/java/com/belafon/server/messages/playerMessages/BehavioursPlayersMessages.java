...
public class BehavioursPlayersMessages implements BehavioursMessages{
    ...
    public void newFeasibleBehaviour(BehaviourType behaviourType) {
		sendMessage.sendLetter("player feasibleBehaviour add " + behaviourType.behaviourClass.getSimpleName(), PlayersMessageSender.TypeMessage.other);
    }

    @Override
    public void removeFeasibleBehaviour(BehaviourType behaviourType) {
        sendMessage.sendLetter("player feasibleBehaviour remove " + behaviourType.behaviourClass.getSimpleName(), PlayersMessageSender.TypeMessage.other);
    }
