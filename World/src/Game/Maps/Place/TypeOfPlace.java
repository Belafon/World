...
public class TypeOfPlace {
    ...
    public final TypeOfResourceWithPressence[] typeOfResources;
    public final int[] altitudesOfPressence;
    public final int evaporationRate; 
    public TypeOfPlace(NamesOfTypesOfPlaces name, String[] pictures, String[] music, int[] altitudesOfPressence, TypeOfResourceWithPressence[] typeOfResources, int evaporationRate, int color, String look) {
        this.name = name;
        this.color = color;
        this.look = look;
